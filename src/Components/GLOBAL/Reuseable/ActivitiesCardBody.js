...
const ActivitiesCardBody = ({
  ...
  const { axiosConfig, countryTimestamp, countryDateTime } = useContext(AuthContext);
 ...
 */
  ...
  let EventDateWithEndTime = new Date(moment(countryDateTime(ActualEventDate + ' ' + EndTime, '')));
  let EventDateWithStartTime = new Date(moment(countryDateTime(ActualEventDate + ' ' + StartTime, '')));
  ...
  useEffect(() => {
    ...
    EventDateWithEndTime = new Date(moment(countryDateTime(ActualEventDate + ' ' + EndTime, '')));
    EventDateWithStartTime = new Date(moment(countryDateTime(ActualEventDate + ' ' + StartTime, '')));
                  ...
                  <>
                    {EventDateWithStartTime.getTime() >
                      ...
                      <>
                        ...
                        /> */}
                        {eventStart &&
                          <View style={{ backgroundColor: '#ffffff8e', paddingVertical: 2, paddingHorizontal: 3, borderRadius: 5 }}>
                            <CountDown
