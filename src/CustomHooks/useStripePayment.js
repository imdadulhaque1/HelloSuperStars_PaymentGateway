...
export const useStripePayment = (data) => {
    ...
    const HandelStripePayment = (data) => {
        ...
        axios.post(AppUrl.stripeMobilePayment, data, axiosConfig).then((res) => {
    ...
    return { stripeBuffer, stripeError, HandelStripePayment, openPaymentSheet, stripePaymentStatus }
